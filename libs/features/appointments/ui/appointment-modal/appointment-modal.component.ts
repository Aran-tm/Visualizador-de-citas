      ...
      <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col border border-slate-200/60" (click)="$event.stopPropagation()">
        ...
        <div class="p-6 border-t border-slate-100 bg-slate-50/50 flex flex-wrap gap-3">
          ...
          <button
            ...
            class="px-8 py-3 bg-blue-600 text-white rounded-2xl flex items-center gap-2 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-bold text-sm active:scale-95 cursor-pointer"
          >
            @if (isSubmitting()) {
